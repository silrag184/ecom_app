    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            if (typeof d3.beeswarm !== 'function' && chart.options().observationType() == 'swarm') {
                ...
                noData = 'Please includes the library https://github.com/Kcnarf/d3-beeswarm to use "swarm".'
                nv.utils.noData(chart, container);
                return chart;
...
nv.models.multiBar = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , clipEdge = true
        , stacked = false
        , stackOffset = 'zero' // options includes 'silhouette', 'wiggle', 'expand', 'zero', or a custom function
        , color = nv.utils.defaultColor()
        , hideable = false
