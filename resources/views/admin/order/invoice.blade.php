                                ...
                                <div class="invoice-box">
                                    <table cellpadding="0" cellspacing="0">
                                            ...
                                            <td colspan="2">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Invoice #: 1001{{ $order->id }}<br />
                                                            Created: {{ date('j-F-y',strtotime($order->order_date)) }}<br />
                                                            Delivery Date: {{ date('j-F-y',strtotime($order->delivery_date)) }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr class="details">
                                            ...
                                            <td>{{ $order->currency }} {{ $order->payment_amount }}</td>
                                        </tr>
