                                        ...
                                        @foreach($units as $unit)
                                            <tr>
                                                ...
                                                <td class="justify-content-center">
                                                    <a href="{{ route('units.edit', $unit->id) }}" class="btn btn-primary btn-sm me-2 float-start">
                                                        <i class="fa fa-edit"></i>
                                                    </a>

                                                    @if($unit->status == 1)
                                                        <a href="{{ route('units.show', $unit->id) }}" class="btn btn-warning btn-sm me-2 float-start">
                                                            <i class="fa fa-eye-slash"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{ route('units.show', $unit->id) }}" class="btn btn-success btn-sm me-2 float-start">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    @endif
