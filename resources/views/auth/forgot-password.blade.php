...
<!-- Mirrored from laravel8.spruko.com/noa/forgot-password by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2023 13:13:11 GMT -->
								...
								<form class="card shadow-none" method="POST" action="{{ route('password.email') }}">
									...
									<div class="card-body">
										...
										<div class="pt-3" id="forgot">
											...
											<div>
												<button class="btn btn-primary d-grid text-center">Submit</button>
											</div>
