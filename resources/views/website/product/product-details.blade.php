            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="tab-content nav-material" id="top-tabContent">
                    ...
                    <div class="tab-pane fade" id="top-review" role="tabpanel" aria-labelledby="review-top-tab">
                            ...
                            <div class="col mb-2">
                                <div class="d-flex bg-white">
                                    <div class="flex-shrink-0">
                                        ...
                                        <img src="{{ asset($review->customer->image) }}" alt="" class="rounded-circle" height="70px" width="75px">
                                        @else
                                            <img src="https://greenacresportsmed.com.au/wp-content/uploads/2018/01/dummy-image.jpg" alt="" class="rounded-circle" height="70px" width="75px">
                                        @endif
                                    </div>
                                    <div class="flex-grow-1 ms-3 pt-4">
                                        <h5>{{ $review->customer->name }} <small class="text-muted">Posted on {{ $review->created_at }}</small></h5>
                                        <p>{{ $review->review }}</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="theme-form" action="{{ route('product-review',$product->id) }}" method="POST" >
                            @csrf
                            ...
                            @else
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="{{ route('customer.login') }}" class="btn btn-success">Please login to Review</a>
                                    </div>
                                </div>
