                                                                ...
                                                                <div class="detail-title">
                                                                    ...
                                                                    <div class="detail-right">
                                                                        @if($offerDetail->product->discount_amount)
                                                                            <div class="check-price"> {{ $offerDetail->product->regular_price }}.tk</div>
                                                                            <div class="price">
                                                                                <div class="price"> {{ $offerDetail->product->selling_price }}.tk</div>
                                                                            </div>
                                                                        @else
                                                                            <div class="price">
                                                                                <div class="price"> {{ $offerDetail->product->regular_price }}.tk</div>
                                                                            </div>
