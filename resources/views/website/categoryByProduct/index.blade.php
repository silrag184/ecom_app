        ...
        <div class="collection-wrapper">
            <div class="custom-container">
                <div class="row">
                    ...
                    {{--                                                            </ul>--}}
                    {{--                                                            <a href="product.details" tabindex="0"><p>sumsung galaxy</p></a>--}}
                    ...
                    {{--                                                                <li><i class="fa fa-star-o"></i></li>--}}
                    {{--                                                            </ul>--}}
                    {{--                                                            <a href="product.details" tabindex="0"><p>bajaj rex mixer</p></a>--}}
                    ...
                    {{--                                                                <li><i class="fa fa-star-o"></i></li>--}}
                    {{--                                                            </ul>--}}
                    {{--                                                            <a href="product.details" tabindex="0"><p>usha table fan</p></a>--}}
